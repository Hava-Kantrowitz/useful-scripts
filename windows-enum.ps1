...
function JAWS-ENUM {
    ...
    $output = $output +  "##                                                        ##`r`n"
    $output = $output +  "##           https://github.com/411Hall/JAWS I modz tho   ##`r`n"
    $output = $output +  "##                                            UwU         ##`r`n"
    $output = $output +  "############################################################`r`n"
    $output = $output +  "`r`n"
    ...
    $adsi.Children | where {$_.SchemaClassName -eq 'user'} | Foreach-Object {
        ...
        $output = $output +  "LastLogin:   "  + $_.LastLogin +  "`r`n"
        $output = $output +  "Groups:   "  + $_.Description +  "`r`n"
    ...
    $output = $output +  "-----------------------------------------------------------`r`n"
    $output = $output + (netstat -anob | out-string)
    $output = $output +  "`r`n"
    $output = $output +  "`r`n"
    $output = $output +  "-----------------------------------------------------------`r`n"
